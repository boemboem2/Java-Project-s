...
public class Class143 {
	...
	final void method299(boolean flag, boolean flag1, boolean flag2, float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11) {
		...
		if (aBoolean36) {
			aClass_ra_Sub1_31.method1776((int) f3, (int) f, (int) f4, (int) f1, Class460.anIntArray4096[(int) f9 & 0xffff], 0x828f2ffb);
			aClass_ra_Sub1_31.method1776((int) f4, (int) f1, (int) f5, (int) f2, Class460.anIntArray4096[(int) f9 & 0xffff], 0x859f5e57);
			aClass_ra_Sub1_31.method1776((int) f5, (int) f2, (int) f3, (int) f, Class460.anIntArray4096[(int) f9 & 0xffff], 0x8896140e);
			return;
		}
		float f12 = f4 - f3;
		float f13 = f1 - f;
		...
		if (aClass15_24.aBoolean207) {
			if (aBoolean16) {
				...
				if (anInt19 == 0) {
					if (k > 0)
						do {
							j = Class460.anIntArray4096[(int) f & 0xffff];
							f += f1;
							i++;
				...
				if (anInt19 == 0) {
					do {
						i++;
						if (!flag || f2 < aFloatArray35[i]) {
							ai[i] = Class460.anIntArray4096[(int) f & 0xffff];
							if (flag)
								aFloatArray35[i] = f2;
						}
						f2 += f3;
	...
	final void method290(boolean flag, boolean flag1, boolean flag2, float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17, int i, int j, int k, int l, float f18, float f19, float f20, int i1, int j1) {
		if (!flag) {
			method293(false, flag1, flag2, f, f1, f2, f3, f4, f5, f6, f7, f8, 0);
			return;
		}
		int k1 = (i1 & 0xffff) << 16 | j1 & 0xffff;
		if (k1 != anInt37) {
			anIntArray30 = aClass_ra_Sub1_31.method5197(i1, j1);
			if (anIntArray30 == null) {
				anInt37 = -1;
				anInt19 = 255 - (i >> 24 & 0xff);
				anInt54 = 0;
				int l1 = Class460.anIntArray4096[Class658.method1823(aClass_ra_Sub1_31.method5206(i1), 0x1622a8ca) & 0xffff];
				int i2 = 0xff000000 | (i >> 16 & 0xff) * (l1 >> 16 & 0xff) << 8 & 0xff0000 | (i >> 8 & 0xff) * (l1 >> 8 & 0xff) & 0xff00 | (i & 0xff) * (l1 & 0xff) >> 8;
				method292(true, flag1, flag2, f, f1, f2, f3, f4, f5, f6, f7, f8, Class57.method1001(i2, l, f18, 0x2f9687f9), Class57.method1001(i2, l, f19, 0x65732cff), Class57.method1001(i2, l, f20, 0x99113c73));
				return;
			}
			anInt37 = k1;
			anInt39 = aClass_ra_Sub1_31.method5199(i1);
			anInt40 = anInt39 - 1;
			aClass511_1617 = aClass_ra_Sub1_31.method5214(i1);
			aBoolean43 = aClass_ra_Sub1_31.method5212(i1);
			anInt54 = aClass_ra_Sub1_31.method9525(i1) & 0xff;
		}
		anInt18 = l;
		if (f > f1 || f > f2)
			if (f1 <= f2) {
		...
		if (f1 < f2) {
			...
			if (f != f1 && f61 < f39 || f == f1 && f61 > f50) {
				...
				f1 -= f;
				for (f = anIntArray47[(int) f]; --f1 >= 0.0F; f += anInt33) {
					method2461(flag1, flag2, anIntArray34, anIntArray30, (int) f, (int) f5, (int) f3, f8, f6, f11, f9, f14, f12, f17, f15, f20, f18, f26, f23, f30, f27, f34, f31, f38, f35);
					f3 += f39;
					f5 += f61;
					f6 += f40;
					f8 += f62;
				...
				while (--f2 >= 0.0F) {
					method2461(flag1, flag2, anIntArray34, anIntArray30, (int) f, (int) f5, (int) f4, f8, f7, f11, f10, f14, f13, f17, f16, f20, f19, f26, f24, f30, f28, f34, f32, f38, f36);
					f4 += f50;
					f5 += f61;
					f7 += f51;
					f8 += f62;
				...
				f1 -= f;
				for (f = anIntArray47[(int) f]; --f1 >= 0.0F; f += anInt33) {
					method2461(flag1, flag2, anIntArray34, anIntArray30, (int) f, (int) f3, (int) f5, f6, f8, f9, f11, f12, f14, f15, f17, f18, f20, f23, f26, f27, f30, f31, f34, f35, f38);
					f3 += f39;
					f5 += f61;
					f6 += f40;
					f8 += f62;
				...
				while (--f2 >= 0.0F) {
					method2461(flag1, flag2, anIntArray34, anIntArray30, (int) f, (int) f4, (int) f5, f7, f8, f10, f11, f13, f14, f16, f17, f19, f20, f24, f26, f28, f30, f32, f34, f36, f38);
					f4 += f50;
					f5 += f61;
					f7 += f51;
					f8 += f62;
			...
			if (f != f2 && f61 < f39 || f == f2 && f50 > f39) {
				...
				f2 -= f;
				for (f = anIntArray47[(int) f]; --f2 >= 0.0F; f += anInt33) {
					method2461(flag1, flag2, anIntArray34, anIntArray30, (int) f, (int) f4, (int) f3, f7, f6, f10, f9, f13, f12, f16, f15, f19, f18, f25, f23, f29, f27, f33, f31, f37, f35);
					f3 += f39;
					f4 += f61;
					f6 += f40;
					f7 += f62;
				...
				f2 -= f;
				for (f = anIntArray47[(int) f]; --f2 >= 0.0F; f += anInt33) {
					method2461(flag1, flag2, anIntArray34, anIntArray30, (int) f, (int) f3, (int) f4, f6, f7, f9, f10, f12, f13, f15, f16, f18, f19, f23, f25, f27, f29, f31, f33, f35, f37);
					f4 += f61;
					f3 += f39;
					f7 += f62;
					f6 += f40;
	...
	final void method291(boolean flag, boolean flag1, boolean flag2, int ai[], int i, int j, int k, int l, int i1, float f, float f1) {
		if (aBoolean20) {
			if (i1 > anInt22)
				i1 = anInt22;
			if (l < 0)
	...
	final void method2461(boolean flag, boolean flag1, int ai[], int ai1[], int i, int j, int k, float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17) {
		int l = k - j;
		...
		while (l-- > 0) {
			...
			if (!flag || f28 < aFloatArray35[i]) {
				...
				int l1 = 255;
				if (aClass511_1617 == Class511.aClass511_5697)
					l1 = (int) (((float) (k1 >> 24 & 0xff) * f10) / 255F);
				else if (aClass511_1617 == Class511.aClass511_5696) {
					if ((k1 >> 24 & 0xff) > anInt54)
						l1 = 255;
					else
						l1 = 0;
				} else {
	...
	final void method2462(boolean flag, boolean flag1, boolean flag2, float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17, int i, int j, int k, int l, float f18, float f19, float f20, int i1, int j1, float f21, int k1, int l1, float f22, int i2, int j2, float f23) {
		if (!flag) {
			method293(false, flag1, flag2, f, f1, f2, f3, f4, f5, f6, f7, f8, 0);
			return;
		}
		...
		int z1 = (i1 & 0xffff) << 16 | j1 & 0xffff;
		int z2 = (k1 & 0xffff) << 16 | l1 & 0xffff;
		int z3 = (i2 & 0xffff) << 16 | j2 & 0xffff;
		if (z1 != anInt37) {
			anIntArray30 = aClass_ra_Sub1_31.method5197(i1, j1);
			if (anIntArray30 == null) {
				anInt37 = -1;
				anInt19 = 255 - (i >> 24 & 0xff);
				int l3 = Class460.anIntArray4096[Class658.method1823(aClass_ra_Sub1_31.method5206(i1), 0x5383803a) & 0xffff];
				int k4 = 0xff000000 | (i >> 16 & 0xff) * (l3 >> 16 & 0xff) << 8 & 0xff0000 | (i >> 8 & 0xff) * (l3 >> 8 & 0xff) & 0xff00 | (i & 0xff) * (l3 & 0xff) >> 8;
				method292(true, flag1, flag2, f, f1, f2, f3, f4, f5, f6, f7, f8, Class57.method1001(k4, l, f18, 0xd64ec645), Class57.method1001(k4, l, f19, 0xe7dd957e), Class57.method1001(k4, l, f20, 0xb2bf3ca));
				return;
			}
			anInt37 = z1;
			anInt39 = aClass_ra_Sub1_31.method5199(i1);
		...
		aFloat41 = f21;
		if (z2 != anInt44) {
			anIntArray45 = aClass_ra_Sub1_31.method5197(k1, l1);
			if (anIntArray45 == null) {
				anInt44 = -1;
				anInt19 = 255 - (i >> 24 & 0xff);
				int i4 = Class460.anIntArray4096[Class658.method1823(aClass_ra_Sub1_31.method5206(k1), 0x27fa64c1) & 0xffff];
				int l4 = 0xff000000 | (i >> 16 & 0xff) * (i4 >> 16 & 0xff) << 8 & 0xff0000 | (i >> 8 & 0xff) * (i4 >> 8 & 0xff) & 0xff00 | (i & 0xff) * (i4 & 0xff) >> 8;
				method292(true, flag1, flag2, f, f1, f2, f3, f4, f5, f6, f7, f8, Class57.method1001(l4, l, f18, 0x2b709993), Class57.method1001(l4, l, f19, 0x6b610838), Class57.method1001(l4, l, f20, 0xb872d512));
				return;
			}
			anInt44 = z2;
			anInt29 = aClass_ra_Sub1_31.method5199(k1);
			anInt28 = anInt29 - 1;
		}
		aFloat32 = f22;
		if (z3 != anInt49) {
			anIntArray50 = aClass_ra_Sub1_31.method5197(i2, j2);
			if (anIntArray50 == null) {
				anInt49 = -1;
				anInt19 = 255 - (i >> 24 & 0xff);
				int j4 = Class460.anIntArray4096[Class658.method1823(aClass_ra_Sub1_31.method5206(i2), 0xf854e8c7) & 0xffff];
				int i5 = 0xff000000 | (i >> 16 & 0xff) * (j4 >> 16 & 0xff) << 8 & 0xff0000 | (i >> 8 & 0xff) * (j4 >> 8 & 0xff) & 0xff00 | (i & 0xff) * (j4 & 0xff) >> 8;
				method292(true, flag1, flag2, (int) f, (int) f1, (int) f2, (int) f3, (int) f4, (int) f5, (int) f6, (int) f7, (int) f8, Class57.method1001(i5, l, f18, 0xcf015ccc), Class57.method1001(i5, l, f19, 0xedb62fd4), Class57.method1001(i5, l, f20, 0x38098961));
				return;
			}
			anInt49 = z3;
			anInt51 = aClass_ra_Sub1_31.method5199(i2);
			anInt52 = anInt51 - 1;
		}
		aFloat53 = f23;
		f12 /= f9;
		...
		if (f1 < f2) {
			...
			if (f != f1 && f76 < f50 || f == f1 && f76 > f63) {
				...
				f1 -= f;
				for (f = anIntArray47[(int) f]; --f1 >= 0.0F; f += anInt33) {
					method2463(flag1, flag2, anIntArray34, (int) f, (int) f5, (int) f3, f8, f6, f11, f9, f14, f12, f17, f15, f20, f18, f29, f26, f33, f30, f37, f34, f41, f38, f45, f42, f49, f46);
					f3 += f50;
					f5 += f76;
					f6 += f51;
					f8 += f77;
				...
				while (--f2 >= 0.0F) {
					method2463(flag1, flag2, anIntArray34, (int) f, (int) f5, (int) f4, f8, f7, f11, f10, f14, f13, f17, f16, f20, f19, f29, f27, f33, f31, f37, f35, f41, f39, f45, f43, f49, f47);
					f4 += f63;
					f5 += f76;
					f7 += f64;
					f8 += f77;
				...
				f1 -= f;
				for (f = anIntArray47[(int) f]; --f1 >= 0.0F; f += anInt33) {
					method2463(flag1, flag2, anIntArray34, (int) f, (int) f3, (int) f5, f6, f8, f9, f11, f12, f14, f15, f17, f18, f20, f26, f29, f30, f33, f34, f37, f38, f41, f42, f45, f46, f49);
					f3 += f50;
					f5 += f76;
					f6 += f51;
					f8 += f77;
				...
				while (--f2 >= 0.0F) {
					method2463(flag1, flag2, anIntArray34, (int) f, (int) f4, (int) f5, f7, f8, f10, f11, f13, f14, f16, f17, f19, f20, f27, f29, f31, f33, f35, f37, f39, f41, f43, f45, f47, f49);
					f4 += f63;
					f5 += f76;
					f7 += f64;
					f8 += f77;
			...
			if (f != f2 && f76 < f50 || f == f2 && f63 > f50) {
				...
				f2 -= f;
				for (f = anIntArray47[(int) f]; --f2 >= 0.0F; f += anInt33) {
					method2463(flag1, flag2, anIntArray34, (int) f, (int) f4, (int) f3, f7, f6, f10, f9, f13, f12, f16, f15, f19, f18, f28, f26, f32, f30, f36, f34, f40, f38, f44, f42, f48, f46);
					f3 += f50;
					f4 += f76;
					f6 += f51;
					f7 += f77;
				...
				f2 -= f;
				for (f = anIntArray47[(int) f]; --f2 >= 0.0F; f += anInt33) {
					method2463(flag1, flag2, anIntArray34, (int) f, (int) f3, (int) f4, f6, f7, f9, f10, f12, f13, f15, f16, f18, f19, f26, f28, f30, f32, f34, f36, f38, f40, f42, f44, f46, f48);
					f4 += f76;
					f3 += f50;
					f7 += f77;
					f6 += f51;
	...
	final void method2463(boolean flag, boolean flag1, int ai[], int i, int j, int k, float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17, float f18, float f19, float f20, float f21) {
		int l = k - j;
	...
	final void method292(boolean flag, boolean flag1, boolean flag2, float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7, float f8, int i, int j, int k) {
		...
		if (aBoolean36) {
			aClass_ra_Sub1_31.method1776((int) f3, (int) f, (int) f4, (int) f1, 0xff000000 | i, 0xaaa04ad7);
			aClass_ra_Sub1_31.method1776((int) f4, (int) f1, (int) f5, (int) f2, 0xff000000 | i, 0xacdced69);
			aClass_ra_Sub1_31.method1776((int) f5, (int) f2, (int) f3, (int) f, 0xff000000 | i, 0x85d44780);
			return;
		}
		float f9 = f4 - f3;
		float f10 = f1 - f;
	...
	final void method2470(boolean flag) {
		aBoolean36 = flag;
	}

	Class143(Class106_Sub2 class106_sub2, Class186 class186) {
		aBoolean36 = false;
		aBoolean16 = true;
		aBoolean48 = false;
		anInt19 = 0;
		...
		anInt52 = 0;
		aFloat53 = 0.0F;
		aClass_ra_Sub1_31 = class106_sub2;
		aClass15_24 = class186;
		anInt33 = aClass_ra_Sub1_31.anInt10217 * 0xc4b2ec17;
		anIntArray34 = aClass_ra_Sub1_31.anIntArray10218;
		aFloatArray35 = aClass_ra_Sub1_31.aFloatArray10219;
		aClass511_1617 = Class511.aClass511_5695;
	}
	...
	final void method293(boolean flag, boolean flag1, boolean flag2, float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7, float f8, int i) {
		if (aBoolean36) {
			aClass_ra_Sub1_31.method1776((int) f3, (int) f, (int) f4, (int) f1, i, 0xa156520a);
			aClass_ra_Sub1_31.method1776((int) f4, (int) f1, (int) f5, (int) f2, i, 0x9c9fa2d6);
			aClass_ra_Sub1_31.method1776((int) f5, (int) f2, (int) f3, (int) f, i, 0xacc82ebf);
			return;
		}
		float f9 = f4 - f3;
		float f10 = f1 - f;
		...
		if (f <= f1 && f <= f2) {
			...
			if (f1 < f2) {
				...
				if (f != f1 && f17 < f15 || f == f1 && f17 > f16) {
					...
					f1 -= f;
					for (f = anIntArray47[(int) f]; --f1 >= 0.0F; f += anInt33) {
						method291(flag, flag1, flag2, anIntArray34, (int) f, i, 0, (int) f5, (int) f3, f6, f19);
						f5 += f17;
						f3 += f15;
						f6 += f20;
					}
					...
					while (--f2 >= 0.0F) {
						method291(flag, flag1, flag2, anIntArray34, (int) f, i, 0, (int) f5, (int) f4, f6, f19);
						f5 += f17;
						f4 += f16;
						f6 += f20;
						f += anInt33;
				...
				f1 -= f;
				for (f = anIntArray47[(int) f]; --f1 >= 0.0F; f += anInt33) {
					method291(flag, flag1, flag2, anIntArray34, (int) f, i, 0, (int) f3, (int) f5, f6, f19);
					f5 += f17;
					f3 += f15;
					f6 += f20;
				}
				...
				while (--f2 >= 0.0F) {
					method291(flag, flag1, flag2, anIntArray34, (int) f, i, 0, (int) f4, (int) f5, f6, f19);
					f5 += f17;
					f4 += f16;
					f6 += f20;
					f += anInt33;
			...
			if (f != f2 && f17 < f15 || f == f2 && f16 > f15) {
				...
				f2 -= f;
				for (f = anIntArray47[(int) f]; --f2 >= 0.0F; f += anInt33) {
					method291(flag, flag1, flag2, anIntArray34, (int) f, i, 0, (int) f4, (int) f3, f6, f19);
					f4 += f17;
					f3 += f15;
					f6 += f20;
				}
			...
			f2 -= f;
			for (f = anIntArray47[(int) f]; --f2 >= 0.0F; f += anInt33) {
				method291(flag, flag1, flag2, anIntArray34, (int) f, i, 0, (int) f3, (int) f4, f6, f19);
				f4 += f17;
				f3 += f15;
				f6 += f20;
			}
		...
		if (f1 <= f2) {
			...
			if (f2 < f) {
				...
				if (f1 != f2 && f15 < f16 || f1 == f2 && f15 > f17) {
					...
					f2 -= f1;
					for (f1 = anIntArray47[(int) f1]; --f2 >= 0.0F; f1 += anInt33) {
						method291(flag, flag1, flag2, anIntArray34, (int) f1, i, 0, (int) f3, (int) f4, f7, f19);
						f3 += f15;
						f4 += f16;
						f7 += f20;
					}
					...
					while (--f >= 0.0F) {
						method291(flag, flag1, flag2, anIntArray34, (int) f1, i, 0, (int) f3, (int) f5, f7, f19);
						f3 += f15;
						f5 += f17;
						f7 += f20;
						f1 += anInt33;
				...
				f2 -= f1;
				for (f1 = anIntArray47[(int) f1]; --f2 >= 0.0F; f1 += anInt33) {
					method291(flag, flag1, flag2, anIntArray34, (int) f1, i, 0, (int) f4, (int) f3, f7, f19);
					f3 += f15;
					f4 += f16;
					f7 += f20;
				}
				...
				while (--f >= 0.0F) {
					method291(flag, flag1, flag2, anIntArray34, (int) f1, i, 0, (int) f5, (int) f3, f7, f19);
					f3 += f15;
					f5 += f17;
					f7 += f20;
					f1 += anInt33;
			...
			if (f15 < f16) {
				...
				f -= f1;
				for (f1 = anIntArray47[(int) f1]; --f >= 0.0F; f1 += anInt33) {
					method291(flag, flag1, flag2, anIntArray34, (int) f1, i, 0, (int) f5, (int) f4, f7, f19);
					f5 += f15;
					f4 += f16;
					f7 += f20;
				}
			...
			f -= f1;
			for (f1 = anIntArray47[(int) f1]; --f >= 0.0F; f1 += anInt33) {
				method291(flag, flag1, flag2, anIntArray34, (int) f1, i, 0, (int) f4, (int) f5, f7, f19);
				f5 += f15;
				f4 += f16;
				f7 += f20;
			}
		...
		if (f < f1) {
			...
			if (f16 < f17) {
				...
				f -= f2;
				for (f2 = anIntArray47[(int) f2]; --f >= 0.0F; f2 += anInt33) {
					method291(flag, flag1, flag2, anIntArray34, (int) f2, i, 0, (int) f4, (int) f5, f8, f19);
					f4 += f16;
					f5 += f17;
					f8 += f20;
				}
				...
				while (--f1 >= 0.0F) {
					method291(flag, flag1, flag2, anIntArray34, (int) f2, i, 0, (int) f4, (int) f3, f8, f19);
					f4 += f16;
					f3 += f15;
					f8 += f20;
					f2 += anInt33;
			...
			f -= f2;
			for (f2 = anIntArray47[(int) f2]; --f >= 0.0F; f2 += anInt33) {
				method291(flag, flag1, flag2, anIntArray34, (int) f2, i, 0, (int) f5, (int) f4, f8, f19);
				f4 += f16;
				f5 += f17;
				f8 += f20;
			}
			...
			while (--f1 >= 0.0F) {
				method291(flag, flag1, flag2, anIntArray34, (int) f2, i, 0, (int) f3, (int) f4, f8, f19);
				f4 += f16;
				f3 += f15;
				f8 += f20;
				f2 += anInt33;
		...
		if (f16 < f17) {
			...
			f1 -= f2;
			for (f2 = anIntArray47[(int) f2]; --f1 >= 0.0F; f2 += anInt33) {
				method291(flag, flag1, flag2, anIntArray34, (int) f2, i, 0, (int) f3, (int) f5, f8, f19);
				f3 += f16;
				f5 += f17;
				f8 += f20;
			}
		...
		f1 -= f2;
		for (f2 = anIntArray47[(int) f2]; --f1 >= 0.0F; f2 += anInt33) {
			method291(flag, flag1, flag2, anIntArray34, (int) f2, i, 0, (int) f5, (int) f3, f8, f19);
			f3 += f16;
			f5 += f17;
			f8 += f20;
		}
	...
	final void method2473(boolean flag) {
		aBoolean36 = flag;
	}

	Class511 aClass511_1617;
	boolean aBoolean43;
	boolean aBoolean48;
	int anInt19;
	boolean aBoolean20;
	...
	int anInt22;
	boolean aBoolean36;
	Class106_Sub2 aClass_ra_Sub1_31;
	Class186 aClass15_24;
	int anInt52;
	int anIntArray34[];
	float aFloatArray35[];
	boolean aBoolean16;
